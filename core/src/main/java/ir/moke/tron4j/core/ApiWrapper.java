package ir.moke.tron4j.core;

import com.google.protobuf.Message;
import io.grpc.ClientInterceptor;
import ir.moke.tron4j.abi.FunctionEncoder;
...
import ir.moke.tron4j.api.GrpcAPI;
import ir.moke.tron4j.core.contract.Contract;
import ir.moke.tron4j.api.WalletGrpc;
import ir.moke.tron4j.api.WalletSolidityGrpc;
import ir.moke.tron4j.core.contract.ContractFunction;
import ir.moke.tron4j.core.exceptions.IllegalException;
import ir.moke.tron4j.core.key.KeyPair;
import ir.moke.tron4j.core.transaction.TransactionBuilder;
import ir.moke.tron4j.core.utils.ByteArray;
import ir.moke.tron4j.core.utils.Sha256Hash;
import ir.moke.tron4j.core.transaction.TransactionCapsule;
import ir.moke.tron4j.core.utils.Utils;
import ir.moke.tron4j.proto.*;
import ir.moke.tron4j.proto.Chain.Transaction;

import ir.moke.tron4j.proto.Chain.Block;

import ir.moke.tron4j.proto.Common.SmartContract;

import ir.moke.tron4j.proto.Contract.TransferAssetContract;
import ir.moke.tron4j.proto.Contract.UnfreezeBalanceContract;
import ir.moke.tron4j.proto.Contract.FreezeBalanceContract;
import ir.moke.tron4j.proto.Contract.TransferContract;
import ir.moke.tron4j.proto.Contract.VoteWitnessContract;
import ir.moke.tron4j.proto.Contract.TriggerSmartContract;
import ir.moke.tron4j.proto.Contract.AccountUpdateContract;
import ir.moke.tron4j.proto.Contract.AccountCreateContract;
import ir.moke.tron4j.proto.Contract.AssetIssueContract;
import ir.moke.tron4j.proto.Contract.SetAccountIdContract;
import ir.moke.tron4j.proto.Contract.UpdateAssetContract;
import ir.moke.tron4j.proto.Contract.UpdateBrokerageContract;
import ir.moke.tron4j.proto.Contract.ParticipateAssetIssueContract;
import ir.moke.tron4j.proto.Contract.UnfreezeAssetContract;
import ir.moke.tron4j.proto.Contract.AccountPermissionUpdateContract;
import ir.moke.tron4j.proto.Contract.WitnessCreateContract;
import ir.moke.tron4j.proto.Contract.WitnessUpdateContract;
import ir.moke.tron4j.proto.Contract.ProposalCreateContract;
import ir.moke.tron4j.proto.Contract.ProposalApproveContract;
import ir.moke.tron4j.proto.Contract.ProposalDeleteContract;
import ir.moke.tron4j.proto.Contract.CancelAllUnfreezeV2Contract;
import ir.moke.tron4j.utils.Base58Check;

import ir.moke.tron4j.proto.Contract.FreezeBalanceV2Contract;
import ir.moke.tron4j.proto.Contract.UnfreezeBalanceV2Contract;
import ir.moke.tron4j.proto.Contract.DelegateResourceContract;
import ir.moke.tron4j.proto.Contract.UnDelegateResourceContract;
import ir.moke.tron4j.proto.Contract.WithdrawExpireUnfreezeContract;
import ir.moke.tron4j.proto.Contract.WithdrawBalanceContract;
 ...
 * @see ir.moke.tron4j.core.contract.Contract
 * @see ir.moke.tron4j.proto.Chain.Transaction
 * @see ir.moke.tron4j.proto.Contract
 */
...
public class ApiWrapper {
    ...
    private TransactionCapsule createTransactionCapsuleWithoutValidate(
        ...
        if (contractType == Transaction.Contract.ContractType.CreateSmartContract) {
            ...
            ir.moke.tron4j.proto.Contract.CreateSmartContract contract = Utils.getSmartContractFromTransaction(trx.getTransaction());
     ...
     * @param txn signed transaction ready to be broadcasted
     ...
     */
    public EstimateEnergyMessage estimateEnergy(String ownerAddr, String contractAddr, Function function) {
        Contract cntr = getContract(contractAddr);
        ...
        TriggerSmartContract trigger =
            TriggerSmartContract.newBuilder()
                ...
                .setData(parseHex(encodedHex))
                .build();
        EstimateEnergyMessage estimateEnergyMessage= blockingStub.estimateEnergy(trigger);
     ...
     * @return EstimateEnergyMessage. Estimated energy to run the contract
     */
    public EstimateEnergyMessage estimateEnergyV2(String ownerAddr, String contractAddr, String callData) {
        Contract cntr = getContract(contractAddr);
    ...
    public PricesResponseMessage getBandwidthPrices() {
        PricesResponseMessage prices = blockingStub.getBandwidthPrices(GrpcAPI.EmptyMessage.getDefaultInstance());
        return prices;
    }
    ...
    public PricesResponseMessage getEnergyPrices() {
        PricesResponseMessage prices = blockingStub.getEnergyPrices(GrpcAPI.EmptyMessage.getDefaultInstance());
        return prices;
    }
    ...
    public PricesResponseMessage getMemoFee() {
        PricesResponseMessage prices = blockingStub.getMemoFee(GrpcAPI.EmptyMessage.getDefaultInstance());
        return prices;
    }
    ...
    public PricesResponseMessage getBandwidthPricesOnSolidity() {
        PricesResponseMessage prices = blockingStubSolidity.getBandwidthPrices(GrpcAPI.EmptyMessage.getDefaultInstance());
        return prices;
    }
    ...
    public PricesResponseMessage getEnergyPricesOnSolidity() {
        PricesResponseMessage prices = blockingStubSolidity.getEnergyPrices(GrpcAPI.EmptyMessage.getDefaultInstance());
        return prices;
    }
